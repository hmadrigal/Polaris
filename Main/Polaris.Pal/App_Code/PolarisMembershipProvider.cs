...
namespace Polaris.Pal.Code
{
    ...
    public class PolarisMembershipProvider : MembershipProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            {
                throw new ApplicationException(String.Format("The application failed when tried to get access to the data source. {0}", ex.ToString()));
            }
        ...
        public override bool ChangePassword(string username, string oldPassword, string newPassword)
        {
            ...
            if (verificationCode != PolarisPasswordVerificationCode.ValidPassword) throw new ArgumentException(String.Format("The newpassword argument does not acomplish the requiered security. Reported fail:{0}", verificationCode.ToString()), "newPassword");
            ...
            if (user == null) throw new ApplicationException(String.Format("Application cannot find the username {0}.", username));
            else
            {
        ...
        public override string ResetPassword(string username, string answer)
        {
            ...
            if (!user.Active) throw new InvalidOperationException(String.Format("User {0} is not activated. {1} cannot reset the password for this user", user.Username, this.className));

            if (this.passwordFormat != MembershipPasswordFormat.Hashed) throw new NotImplementedException(String.Format("{0} is not supporting reset password when Password format is {1}. Try to set the password format to {2}", this.className, this.passwordFormat, MembershipPasswordFormat.Hashed.ToString()));
        ...
        {
            if (String.IsNullOrEmpty(password)) return PolarisPasswordVerificationCode.InvalidPasswordPasswordIsEmpty;
            if (this.minRequiredPasswordLength > 0 && password.Length < this.minRequiredPasswordLength) return PolarisPasswordVerificationCode.InvalidPasswordIncorrectLength;
