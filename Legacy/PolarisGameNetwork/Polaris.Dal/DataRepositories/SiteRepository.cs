...
namespace Polaris.Dal {
  public class SiteRepository : Repository, ISiteRepository {
    ...
    public SiteRepository(PolarisDataContext dataContext) : base(dataContext) {
      RegisteredEntities.Add(typeof(IUser), new User());
    }

    public SiteRepository() : this(new PolarisDataContext()) { }
