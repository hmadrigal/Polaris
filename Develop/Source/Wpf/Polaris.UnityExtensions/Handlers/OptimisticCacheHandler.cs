...
namespace Polaris.UnityExtensions
{
    ...
    /// </summary>
    [ConfigurationElementType(typeof(OptimisticCacheHandler)), Synchronization]
    public class OptimisticCacheHandler : ICallHandler
    {
        #region Fields
        ...
        public OptimisticCacheHandler()
            : this(null, null, null, TimeSpan.Zero) { }

        public OptimisticCacheHandler(TimeSpan expirationTime)
        ...
        private IMethodReturn TryToInvoke(string cacheKey, IMethodReturn returnResult)
        {
        ...
        private object getCachedResult(string cacheKey)
        {
            ...
            var cachedValueCast = cachedValue as OptimisticCacheHandler;
